...
const page = () => {
  ...
  const retrievePages = () => fetchData('http://localhost:3000/website-scrapper/api/get_pages?site=https://espacecouture.fr/', setPages,setImages);
  const retrieveRessources = () => fetchData('http://localhost:3000/website-scrapper/api/get_ressources?site=https://espacecouture.fr/', setRessources);
  const retrieveImages = () => fetchData('http://localhost:3000/website-scrapper/api/get_images?site=https://espacecouture.fr/', setImages,setRessources);
    ...
    <>
      ...
      <div className="mx-auto bg-gray-800 h-full max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg text-center">
          <h1 className="text-2xl font-bold sm:text-3xl">Retrieve Data</h1>
          ...
          <div className='container bg-gray-900 h-full max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8'>
            ...
            <div className='Pages flex flex-wrap items-center justify-between mb-4 p-4 bg-gray-800 rounded-lg shadow-md'>
             ...
             { showNext && <button className='bg-blue-500  text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300'>Next</button>
            }
          </div>
