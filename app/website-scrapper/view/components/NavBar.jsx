...
const NavBar = () => {
  return (
    ...
    <nav className="bg-gray-800 shadow bg-gray-900">
  <div className="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
    <a
      href="#"
      className=" transition-colors duration-300 hover:text-blue-500 text-blue-500   transform dark:text-gray-200 border-b-2 border-blue-500 mx-1.5 sm:mx-6"
    >
      Sites
    </a>
    <a
      href="#"
      className="border-b-2 border-transparent text-white hover:text-blue-500 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"
    >
      features
    </a>
    <a
      href="#"
      className="border-b-2 border-transparent text-white hover:text-blue-500 transition-colors duration-300 transform   hover:border-blue-500 mx-1.5 sm:mx-6"
    >
      pricing
    </a>
    <a
    ...
    <a
      href="#"
      className="border-b-2 border-transparent text-whitehover:text-blue-500  transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"
    >
      <svg
